...
`id` int(10) ENGINE NOT NULL AUTO_INCREMENT,
...
`zip` int(5) ENGINE NOT NULL,
`startDate` datetime NOT NULL,
`endDate` datetime DEFAULT NULL,
`userId` int(10) ENGINE DEFAULT NULL,
`aboutMe` varchar(255) DEFAULT NULL,
`present` tinyint(1) ENGINE DEFAULT '0',
...
`dogQtyAllowed` int(3) ENGINE DEFAULT '0',
`catQtyAllowed` int(3) ENGINE DEFAULT '0',
`otherQtyAllowed` int(3) ENGINE DEFAULT '0',
`createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
`updatedAt` datetime DEFAULT NULL,
`deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
`id` int(10) ENGINE NOT NULL AUTO_INCREMENT,
`complexId` int(10) ENGINE NOT NULL,
`bedrooms` int(1) ENGINE NOT NULL,
`bathrooms` int(1) ENGINE NOT NULL DEFAULT '1',
`parking` int(1) ENGINE NOT NULL DEFAULT '0',
`living_area` int(4) ENGINE NOT NULL COMMENT 'SQUARE FEET',
...
`busLine` int(10) ENGINE NOT NULL,
`createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
`updatedAt` datetime DEFAULT NULL,
`deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `friend` (
`id` int(10) ENGINE NOT NULL AUTO_INCREMENT,
`userId` int(10) ENGINE NOT NULL,
`friendId` int(10) ENGINE NOT NULL,
`createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
`updatedAt` datetime DEFAULT NULL,
`deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
`id` int(10) ENGINE NOT NULL,
`firstName` varchar(45) NOT NULL,
`lastName` varchar(45) NOT NULL,
`invitorId` int(10) ENGINE NOT NULL COMMENT 'Ideally, this could be a userId or propertyMgmtCo id but relation doesn’t support plymorphic associations so just have it as userId for now',
...
CREATE TABLE `lease` (
`id` int(10) ENGINE NOT NULL AUTO_INCREMENT,
`propertyId` int(10) ENGINE NOT NULL,
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lessee` (
`leaseId` int(10) ENGINE NOT NULL,
`userId` int(10) ENGINE NOT NULL,
`createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
`updatedAt` datetime DEFAULT NULL,
`deletedAt` datetime DEFAULT NULL,
...
`lengthOfStay` int(3) ENGINE DEFAULT NULL COMMENT 'in months',
...
`numRoommates` int(2) ENGINE DEFAULT NULL,
...
`id` int(10) ENGINE NOT NULL AUTO_INCREMENT,
`payerId` int(10) ENGINE NOT NULL,
`payeeId` int(10) ENGINE NOT NULL,
...
`weightLbs` int(10) ENGINE DEFAULT NULL,
`createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
`updatedAt` datetime DEFAULT NULL,
`deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
`bedrooms` int(1) ENGINE DEFAULT NULL,
`bathrooms` int(1) ENGINE DEFAULT NULL,
`parkingSpots` int(1) ENGINE DEFAULT NULL,
`livingAreaSqFt` int(5) ENGINE DEFAULT NULL,
...
`id` int(10) ENGINE NOT NULL AUTO_INCREMENT,
`listingId` int(10) ENGINE DEFAULT NULL COMMENT 'listing image may not exist for each property image',
`propertyId` int(10) ENGINE NOT NULL COMMENT 'if we decide to have listing images different from property images then create listing image table',
`location` varchar(255) NOT NULL COMMENT 'location on storage like S3 or cloudfront',
`createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
`updatedAt` datetime DEFAULT NULL,
`deletedAt` datetime DEFAULT NULL,
...
`id` int(10) ENGINE NOT NULL AUTO_INCREMENT,
`propertyId` int(10) ENGINE NOT NULL,
`ownerId` int(10) ENGINE NOT NULL,
`qtyDogsAllowed` int(2) ENGINE NOT NULL DEFAULT '0',
`qtyCatsAllowed` int(2) ENGINE NOT NULL DEFAULT '0',
`qtyOtherAllowed` int(2) ENGINE NOT NULL DEFAULT '0',
`animalSizeLimitLbs` int(3) NOT NULL DEFAULT '25',
`fishTankAllowed` tinyint(1) NOT NULL DEFAULT '0',
`preferredLeaseLength` int(3) ENGINE NOT NULL,
...
`leaseLength` int(3) ENGINE NOT NULL,
...
`sharedBathroom` tinyint(1) DEFAULT NULL,
`numRoomates` int(3) ENGINE NOT NULL,
`furnished` tinyint(1) DEFAULT NULL,
...
`id` int(10) ENGINE NOT NULL AUTO_INCREMENT,
`propertyId` int(10) ENGINE NOT NULL,
`creatorId` int(10) ENGINE NOT NULL,
`monthlyPrice` float(5,2) NOT NULL,
`securityDeposit` float(5,2) DEFAULT '0.00',
`availableMoveIn` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
`leaseEndDate` datetime DEFAULT NULL,
...
`propertyOwnershipId` int(10) ENGINE NOT NULL,
`ownerId` int(10) ENGINE NOT NULL,
`createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
`updatedAt` datetime DEFAULT NULL,
`deletedAt` datetime DEFAULT NULL,
...
`endDate` datetime NOT NULL,
`propertyFK` int(10) ENGINE NOT NULL,
`id` int(10) ENGINE NOT NULL AUTO_INCREMENT,
`createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
`updatedAt` datetime DEFAULT NULL,
`deletedAt` datetime DEFAULT NULL,
...
`userId` int(10) ENGINE NOT NULL,
`id` int(10) ENGINE NOT NULL AUTO_INCREMENT,
`rentalAppId` int(10) ENGINE NOT NULL,
...
`id` int(10) ENGINE NOT NULL AUTO_INCREMENT,
`propertyId` int(10) ENGINE NOT NULL,
`preferredLeaseLength` int(3) ENGINE DEFAULT NULL,
`preferredMoveIn` datetime NOT NULL,
`numOccupants` int(10) ENGINE NOT NULL DEFAULT '1' COMMENT 'number of occupants needs to be filled in and should be >= to number of applicants for this specific application',
...
`id` int(10) ENGINE NOT NULL AUTO_INCREMENT,
`userId` int(10) ENGINE NOT NULL,
`roommateId` int(10) ENGINE NOT NULL,
...
`id` int(10) ENGINE NOT NULL AUTO_INCREMENT,
`universityId` int(10) ENGINE NOT NULL,
`year` int(4) NOT NULL,
...
`id` int(10) ENGINE NOT NULL AUTO_INCREMENT,
`cosingeeId` int(10) ENGINE NOT NULL,
`cosginerId` int(10) ENGINE NOT NULL,
`createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
`updatedAt` datetime DEFAULT NULL,
`deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
`startDate` datetime NOT NULL,
`endDate` datetime DEFAULT NULL,
`individualAnnualIncom` int(10) ENGINE DEFAULT NULL,
`householdAnnualIncome` int(10) ENGINE DEFAULT NULL,
`spouseAnnualIncome` int(10) ENGINE DEFAULT NULL,
...
`id` int(10) ENGINE NOT NULL AUTO_INCREMENT,
`recommendedId` int(10) ENGINE NOT NULL,
`recommendorId` int(10) ENGINE NOT NULL,
`recommendedApproved` tinyint(1) ENGINE NOT NULL DEFAULT '0',
