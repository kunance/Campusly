...
INSERT INTO room_listing ("propertyId",
  ...
  "smokingAllowed",
  "description")
VALUES (3, 2, 1000, 100, 'now', '2015-12-31 11:59:59-01', 'month-to-month', 'no preference', 100, 'single', 3, 'true', 'false', 'true', 'false', 'a spacious room 10 X 20'),
(4, 4, 600, 600, 'now', '2015-4-15 11:59:59-01', 'month-to-month', 'no preference', 50, 'double', 2, 'true', 'true', 'true', 'false', 'Furnished room to share with great roommates'),
...
(6,7,360,360,'2015-03-07','2015-07-31','sub-lease','no preference',30,'living room',4,'true','false','false','false','AVAILABLE: Living room spot at costa verde towers got $360 a month + utilities around $30. Living room is already sectioned off for you msg me'),
(7,5,770,770,'2015-03-07','2015-06-30','sub-lease','no preference',0,'single',3,'false','true','false','false','Subleasing a masteroom in Costa verde 770+utilities( fully furnished). From right now to summer!'),
