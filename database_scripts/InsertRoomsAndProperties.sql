...
(5,17,500,0,'2015-03-07','2015-05-30','sub-lease','female only',0,'double',2,'true','false','true','true','looking for someone to occupy a single bedroom at Costa Verde North Village (8730) for April 1st - May 30th. Personal Parking space included. You will be sharing a bathroom with 1 guy who lives in the living room. Extremely quiet unit, respectful roommates. Non-smoker, no partying'),
(6,17,360,360,'2015-03-07','2015-07-31','sub-lease','no preference',30,'living room',4,'true','false','false','false','AVAILABLE: Living room spot at costa verde towers got $360 a month + utilities around $30. Living room is already sectioned off for you msg me'),
(7,17,770,770,'2015-03-07','2015-06-30','sub-lease','no preference',0,'single',3,'false','true','false','false','Subleasing a masteroom in Costa verde 770+utilities( fully furnished). From right now to summer!'),
