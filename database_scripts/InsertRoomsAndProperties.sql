INSERT INTO property ("id", "streetNumeric",
 ...
 -- "otherFee",
 -- "status")
VALUES (3, 1290, 'Playmor Ave', 'San Jose', 'CA', 95126, '', '', 37.3161403, -121.91009730000002, 'sfh', 'a cool space', 3, 2),
(4, 1400, 'Playmor Ave', 'San Diego', 'CA', 92121, '', '', 36.3161403, -122.91009730000002, 'apt', 'a cool space', 4, 2),
