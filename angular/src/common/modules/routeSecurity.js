(function (angular) {
    ...
    RouteSecurityManager.prototype = {
        _init: function () {
            ...
            self._rootScope.$on('fbase:login', angular.bind(this, this._login));
            self._rootScope.$on('fbase:logout', angular.bind(this, this._logout));
            self._rootScope.$on('fbase:error', angular.bind(this, this._error));
        },
